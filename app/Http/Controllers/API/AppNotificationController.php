...
class AppNotificationController extends Controller
{
    ...
    /* voip Token */
    public function notification($fcm_token, $title, $message, $id = null, $chat_token = null, $channelName = null, $type = NULL)
    {
        try {
            $response = [];
            ...
            $user = auth()->user();
            $member = member($user->church_id, $request->member_id);
            if(!$member)
            {   
            ...
            $groupArr = [
                'church_name' => church_name_helper($user->church_id),
                'member_id' => $member->id,
