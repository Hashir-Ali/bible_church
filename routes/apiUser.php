...
Route::group(['middleware' => ['auth:api', 'user' ] ], function() {
   ...
   // namespace($this->namespace)
    ...
    Route::post('user/church/update', [UserController::class, 'userChurchUpdate'])->name('user.church.update');
    ...
    Route::get('friend/getFriendIdByUniqueID/{uniqueID}', [FriendController::class, 'getFriendIdByUniqueID']);
